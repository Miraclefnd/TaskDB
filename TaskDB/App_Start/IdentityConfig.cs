...
namespace TaskDB
{
    public class EmailService : IIdentityMessageService
    {
        public async  Task SendAsync(IdentityMessage message)
        {
            ...
            var from = new EmailAddress("danielsmithld@gmail.com", "TaskDB");
            var subject = "Подтверждение учетной записи!";
            var to = new EmailAddress(message.Destination/*"platonova.ann.kos@gmail.com", "Example User"*/);
            var plainTextContent = message.Body/*"Hello, Email from the helper [SendSingleEmailAsync]!"*/;
            var htmlContent = message.Body/*"<strong>Hello, Email from the helper! [SendSingleEmailAsync]</strong>"*/;
            var msg = MailHelper.CreateSingleEmail(from, to, subject, plainTextContent, htmlContent);

            await client.SendEmailAsync(msg);
            //var from = "TaskStudent@yandex.by";
            //var pass = "251207danser";
